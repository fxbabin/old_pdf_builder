...
def get_arguments():
    ...
    parser.add_argument('-t', '--pdf_title', type=str, default="Day00 - PostgreSQL",
        help='Title of the day (or documentation)', required=True)
    ...
    try:
        ...
        for f in files.decode().split('\n'):
            ...
            with open(f, 'r') as infile:
                ...
                content = files_formatting.change_empty_code_block_style(f, content)
        ...
        files_formatting.run_pandoc_all(args.output_file.split('/')[-1], args.debug)
