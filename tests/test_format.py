...
class Test_check_bootcamp_title:
    def test_none_title(self):
        try:
            ...
            assert str(
                e) == '[Error] :: invalid bootcamp title length ! \
    ...
    def test_spec_char_title(self):
        try:
            ...
            assert str(
                e) == '[Error] :: invalid bootcamp title chars \
                    ([A-Za-z ] allowed)'
...
class Test_check_day_title:
    def test_none_title(self):
        try:
            ...
            assert str(
                e) == '[Error] :: invalid day title length ! \
                    (length must be between 11 and 40)'
    ...
    def test_format_title(self):
        try:
            ...
            assert str(
                e) == '[Error] :: invalid day title ! (it must be \
                    formatted as follows \"DayXX - ...\")'
...
class Test_change_img_format:
    ...
    def test_image_md_style_ko(self):
        try:
            ...
            assert str(
                e) == "[Error] toto.md:1 :: wrong image style \
                    format ! (example: '{width=250px}')"
    ...
    def test_empty_image_space_front(self):
        try:
            res = change_img_format(
                "toto.md", " ![toto](src/toto.png){width=450px}\n")
...
class Test_change_header_format:
    ...
    def test_header_4_space_front(_self):
        try:
            ...
            assert str(
                e) == '[Error] toto.md:1 :: too much space(s) in \
                    front of header !'
...
class Test_change_list_format:
    ...
    def test_list_inner_1_wrong_factor(self):
        try:
            ...
            assert str(
                e) == '[Error] toto.md:5 :: number of spaces in \
                    front of list is not a factor of 4 !'
    ...
    def test_list_inner_2_wrong_factor(self):
        try:
            ...
            assert str(
                e) == '[Error] toto.md:6 :: number of spaces in front \
                    of list is not a factor of 4 !'
...
class Test_change_empty_block_style:
    ...
    def test_wrong_block_number(self):
        try:
            ...
            assert str(
                e) == '[Error] toto.md:6 :: could not find closing \
                    code snippet !'
